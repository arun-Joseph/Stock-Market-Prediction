...
interpolated_df.to_pickle('/Users/arunjoseph/Documents/Project Stock predictions/data/pickled_ten_year_filtered_lead_para.pkl')


# Save pandas frame in csv form
interpolated_df.to_csv('/Users/arunjoseph/Documents/Project Stock predictions/data/sample_interpolated_df_10_years_filtered_lead_para.csv',
                       sep='\t', encoding='utf-8')



# Reading the data as pickle file
dataframe_read = pd.read_pickle('/Users/arunjoseph/Documents/Project Stock predictions/data/pickled_ten_year_filtered_lead_para.pkl')
